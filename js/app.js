// DOM elements
const batteryChargeBarsLabel = document.querySelector('#battery-charge-bars-label');
const batteryChargeLinealLabel = document.querySelector('#battery-charge-lineal-label');
